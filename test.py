...
tracks_root = Path("/media/wombat/c6928dc9-ba03-411d-9483-8e28df5973b9/Music Data/Traning Data/maestro-v3.0.0/2004/")
tracks = list(glob.glob(tracks_root + "*.midi"))
track_paths = []
for t in tracks:
...
split_files_for_training(track_paths, tokenizer, root_dir, 512, preprocessing_method=preprocessing_method)